...
ROUTE_GROUP_SPECS = [
    ...
    ("stock.research_surface", "stock", "authenticated_user", None, "^/api/v1/stocks/(?:extract-from-image|parse-import|\\{stock_code\\}/(?:research-packet|evidence|intraday|history|technical-indicators))$", ["GET", "POST"], "Stock research, import, history, and technical-indicator routes are authenticated-member surfaces; quote and consumer-safe validation remain explicitly public."),
