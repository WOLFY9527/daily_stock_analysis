...
| `/api/v1/backtest/rule/compare` | POST | 对比 2-10 条已完成规则回测的 stored-first 摘要视图，并返回 `market_code_comparison`、`period_comparison`、baseline/delta `comparison_summary` 与参数集 `parameter_comparison` |
