...
| `/api/v1/backtest/rule/compare` | POST | Compare 2-10 completed rule runs through a stored-first summary view with `market_code_comparison`, `period_comparison`, baseline/delta `comparison_summary`, parameter-set `parameter_comparison`, and overall `robustness_summary` |
