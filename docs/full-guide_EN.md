...
| `/api/v1/backtest/rule/compare` | POST | Compare 2-10 completed rule runs through a stored-first summary view with `market_code_comparison`, `period_comparison`, baseline/delta `comparison_summary`, and parameter-set `parameter_comparison` |
