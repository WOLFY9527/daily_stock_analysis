...
const LOGIN_COPY: Record<LoginLanguage, {
  ...
  zh: {
    ...
    heroTitleCreate: '创建研究账户',
    heroTitleLogin: '登录进入研究工作台',
    heroBodySetup: '首次启用认证时，先为统一研究环境创建管理员密码。完成后即可进入分析、问股、持仓与回测工作区。',
    heroBodyCreate: '创建一个最小账户后即可进入当前工作台。该阶段仅提供基础登录与个人数据归属能力。',
    heroBodyLogin: '登录后即可继续使用统一的研究壳层、任务状态、报告流和回测工作区。',
    ...
    exitTargets: {
      ...
      scannerDescription: '先回到公开可见的扫描器预览，再决定是否登录进入个人或管理员工作区。',
      homeLabel: '返回首页',
  ...
  en: {
    ...
    authFacts: [
      ...
      'Protected sessions tied to user identity',
      'Analysis, Ask Stock, holdings, and backtests share one product shell',
    ],
    authFactsLabel: 'Authentication facts',
    heroEyebrow: 'Stock research workspace',
    heroTitleSetup: 'Set the admin access password',
    heroTitleCreate: 'Create a research account',
    heroTitleLogin: 'Sign in to research workspace',
    heroBodySetup: 'When authentication is enabled for the first time, create the admin password for the unified research environment before entering analysis, Ask Stock, holdings, and backtest workspaces.',
    heroBodyCreate: 'Create a minimal account to enter this workspace. At this stage it only unlocks basic sign-in and personal data ownership.',
    heroBodyLogin: 'Sign in to continue using the shared research shell, task status, report flow, and backtest workspace.',
    ...
    panelBodyLogin: 'Enter your username and password to continue into this workspace.',
    ...
    continueStandard: 'After the session is established, the app will take you back to the workspace you just tried to open.',
    leaveAuthPage: 'Leave auth page',
    ...
    loadingTextLogin: 'Establishing authorized session',
    submitSetup: 'Finish setup and sign in',
    submitCreate: 'Create account and sign in',
    submitLogin: 'Authorize access',
    ...
    footWorkspace: 'Research workspace',
    footStable: 'Stable interaction',
    redirectTargets: {
      systemSettings: 'System settings',
      adminLogs: 'Admin log center',
      chat: 'Ask Stock workspace',
      portfolio: 'Personal holdings workspace',
      backtestResult: 'Saved backtest result',
      backtest: 'Backtest workspace',
      scanner: 'Scanner workspace',
      settings: 'Personal settings',
      home: 'Home research workspace',
    },
    exitTargets: {
      scannerLabel: 'Back to scanner preview',
      scannerDescription: 'Return to the public scanner preview first, then decide whether to sign in to the personal or admin workspace.',
