...
function adminPortfolioSummaryPayload() {
  return {
    ...
    valuation_scope: 'active_accounts_only',
    valuation_account_count: 1,
    base_currencies: ['USD'],
    accounts: [
      {
        id: 1,
    ...
    broker_sync_summary: {
      ...
      fx_stale: null,
      fx_freshness_state: null,
    },
    valuation_currency: 'USD',
    portfolio_truth: { state: 'fully_valued_nonzero', value_semantics: 'authoritative_total' },
    valuation: { state: 'available', value_semantics: 'authoritative_total' },
    availability: { status: 'ready' },
    fx_lineage: { status: 'available' },
    valuation_snapshot_lineage: { status: 'available' },
    valuation_lineage: { status: 'available' },
    data_status: 'ready',
    calculation_status: 'ready',
    fx_stale: false,
    fx_freshness_state: 'available',
    valuation_lineage_state: 'available',
    ...
    items: [
      {
        ...
        display_market_value: '2160',
        display_unrealized_pnl: '360',
        updated_at: timestamp,
      },
    ],
    total: 1,
